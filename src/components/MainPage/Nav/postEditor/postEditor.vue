    ...
    <div class="postEditorContainer">
        <div class="editorWrapper">
            ...
            <div class="text">
                ...
                <div class="right">
                    <!-- <QuillEditor class="richEditorContent" :options="options" theme="" /> -->
                    <Editor
...
const handleCreated = (editor: any) => {
    ...
    editor.$textElem.addEventListener(
        'paste',
        (event: {preventDefault: () => void; originalEvent: any}) => {
            // 阻止默认粘贴行为，避免粘贴样式
